...
CREATE TABLE IF NOT EXISTS CONTENT_CHANGES(
    ...
    CONSTRAINT FK_CONTENT_CHANGES_ACCEPTOR_USERS FOREIGN KEY(acceptor_id) REFERENCES USERS(id),
    CONSTRAINT UNIQUE_CONTENT_CHANGE UNIQUE(content_id,property_path,operation,from_value,source_value)
);
